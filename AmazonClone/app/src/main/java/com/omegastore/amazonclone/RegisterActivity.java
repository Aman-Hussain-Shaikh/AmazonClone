...
import com.omegastore.amazonclone.model.Users;
                    ...
                    auth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful())
                            {
                                ...
                                imgUri = "https://firebasestorage.googleapis.com/v0/b/clone-669c1.appspot.com/o/profilepicicon.png?alt=media&token=4ff95c66-b981-431d-8381-40694eedc800";
                                ...
                                reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful())
                                        {
                                            ...
                                            progressDialog.dismiss();
                                            Toast.makeText(RegisterActivity.this, "Error increating new user", Toast.LENGTH_SHORT).show();
                                        }
